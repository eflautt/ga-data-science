...
An example of this difference is the relationship between years of education and salary. We know that as education increases, salary should as well. A linear model would say this effect is constant.  In a linear model, as your years of education go from 10 to 15 or from 15 to 20, the increase in salary would be the same. However, using a _non-linear_ model allows us to change the effect depending on the input. We might say that as you move from 10 to 15 years of education, your salary increases by 20k; however, once you move from 15 to 20 years of education your salary might only increase by 5k.
...
This model is attempting to recreate the article exactly as opposed to learning general trends. An unconstrained decision tree can learn a fairly extreme tree!
